  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto">
      ...
      {cart.map((product) => (
        <div
          key={product.id}
          className="grid grid-cols-3 gap-4 items-center border-b border-black py-4 mx-10 px-1"
        >
          <div className="flex items-center space-x-4">
            <img
              src={product.image}
            ...
            <div>
              ...
              <div className="flex items-center gap-1  hover:text-red-400">
                ...
                />
                <button className="text-sm flex items-center cursor-pointer">
                  Delete
                </button>
              </div>
            </div>
          </div>
          <span className="font-medium text-center">{product.quantity}</span>
